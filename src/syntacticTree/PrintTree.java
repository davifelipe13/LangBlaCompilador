...
public class PrintTree {
	...
	public PrintTree() {
		kk = 1; //inicializa o contador de nós
	}
	...
	public void numberClassBodyNode(ClassBodyNode x) {
		if (x == null) return;
		x.number = kk++;
		numberClassDeclListNode(x.fcnode);
	}

//	public void numberRecursiveCallNode(ClassBodyNode x) {
//		if (x == null) return;
//		x.number = kk++;
//		numberClassDeclListNode(x.fcnode);
//		numberVarDeclListNode(x.vlist);
//		numberConstrucDeclListNode(x.ctlist);
